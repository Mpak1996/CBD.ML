...
sns.countplot(x='cyberbullying_type',data=imdf_cyber).set(title="Graph of Datasets")


# ### 6.  WordCloud of Datasets
...
imdf_cyber.to_csv('Datasets/cyberbullying_tweets_class.csv', index=False)
...
imdf_cyber.to_csv('Datasets/cyberbullying_tweets_remove.csv', index=False)
...
imdf_cyber.to_csv('Datasets/cyberbullying_tweets_remove_empty.csv', index=False)
...
# ### 10. Graph of clean Datasets

# In[79]:


sns.set(rc={'figure.figsize':(10.7,7.7)})
sns.countplot(x='cyberbullying_type',data=imdf_cyber).set(title="Graph of clean Datasets")


# ### 11.  WordCloud of clean Datasets
